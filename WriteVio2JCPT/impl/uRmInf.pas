...
var
  RminfXLH: string = '7A1E1D0D070703070B1502010002090200060904020A178C81226D72692E636E';
  RminfWSDL: string = 'http://10.46.177.132:9080/rminf/services/RmOutAccess?wsdl';
...
begin
  ...
  WSIServer := GetRmJaxRpcOutAccess(true, RminfWSDL, Rio);
  try
    if write then
      WSResult := WSIServer.writeObjectOut(xtlb, RminfXLH, jkid, UTF8XmlDoc)
    else
      WSResult := WSIServer.queryObjectOut(xtlb, RminfXLH, jkid, UTF8XmlDoc);
