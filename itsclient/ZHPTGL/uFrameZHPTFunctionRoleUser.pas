...
type
  ...
  TFrameZHPTFunctionRoleUser = class(TdxFrame)
    ...
    procedure cbHavePropertiesChange(Sender: TObject);
  private
    FRoleUsers: TStrings;
    FRoleID: String;
...
procedure TFrameZHPTFunctionRoleUser.cbHavePropertiesChange(Sender: TObject);
begin
  inherited;
  if cbHave.Checked then
  begin
    FDMemTable1.Filter := 'bj = 1';
