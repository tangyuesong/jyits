...
procedure TFrameSignBase.imgviopicMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
var
  rc: TRect;
begin
  ...
  ImageEnView1.IEBitmap.Allocate(rc.Width, rc.Height,
    ImageEnVect1.IEBitmap.PixelFormat);
  ImageEnVect1.IEBitmap.CopyRectTo(ImageEnView1.IEBitmap, rc.left, rc.top, 0, 0,
    rc.Width, rc.Height);
  ImageEnView1.Update;
  ImageEnView1.Fit;
  ImageEnVect1.Paint;
