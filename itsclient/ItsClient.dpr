...
uses
  ...
  uFramePictureCompare in 'DataAnalyse\uFramePictureCompare.pas' {FramePictureCompare: TFrame},
  qjson in 'Common\qjson.pas',
  qrbtree in 'Common\qrbtree.pas',
  QString in 'Common\QString.pas',
  uFrameVioShaiXuan in 'JTWFGL\uFrameVioShaiXuan.pas' {FrameVioShaiXuan: TFrame};
