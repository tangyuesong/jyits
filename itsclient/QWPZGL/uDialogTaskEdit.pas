...
type
  TDialogTaskEdit = class(TdxDialogBaseFrame)
...
var
  DialogTaskEdit: TDialogTaskEdit;
...
procedure TDialogTaskEdit.AfterConstruction;
var
  Y, M, D, H, N, S, SS: Word;
  MM, mc: String;
  dept: TDept;
...
function TDialogTaskEdit.GetDwdm: String;
var
  dwdm: String;
  dept: TDept;
begin
...
function TDialogTaskEdit.GetKpiID(kpiName: String): String;
var
  Kpi, S: String;
begin
  Result := '';
...
function TDialogTaskEdit.GetKPI: TDictionary<string, string>;
var
  S, key, mc: string;
  tb: TFDMemTable;
begin
...
function TDialogTaskEdit.SaveData: Boolean;
var
  ...
  begin
    if dxLayoutGroup3.Components[i] is TdxLayoutItem then
      ...
      begin
        ...
        begin
          Application.MessageBox(PChar('[' + kpiName + ']任务量填写有误'),
            ' 提示 ', MB_OK);
          exit;
        end;
        ...
        if TRequestItf.DbQuery('ModifyJGTask', Param) <> '1' then
        begin
