...
type
  TBorderInsideSvc = class(TService)
...
var
  BorderInsideSvc: TBorderInsideSvc;
...
begin
  BorderInsideSvc.Controller(CtrlCode);
end;

function TBorderInsideSvc.GetServiceController: TServiceController;
begin
  Result := ServiceController;
end;

procedure TBorderInsideSvc.ServiceStart(Sender: TService; var Started: Boolean);
var
  ini: TIniFile;
...
procedure TBorderInsideSvc.SQLError(const SQL, Description: string);
begin
