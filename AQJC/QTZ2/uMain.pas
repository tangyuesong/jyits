...
begin
  ...
  s := IdHTTP1.Get
    (TIdURI.URLEncode
    ('http://127.0.0.1:30086/Login?user=250001&pwd=D3EAFA3C63FC6A7D1DFAADD0203776A1')
  ...
  s := 'http://127.0.0.1:30086/GetSecurityLogList?begin_gxsj=2018/8/19&end_gxsj=2018/8/21&type=&yhbh=&START=0&ROWS=30' +
    '&token=' + s;
