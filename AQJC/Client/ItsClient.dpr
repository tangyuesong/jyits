...
uses
  ...
  uToolDataRoleManage
    in 'XTYXGL\uToolDataRoleManage.pas' {ToolDataRoleManage: TFrame} ,
  ...
  uFrameRoleUserEdit
    in 'XTYXGL\uFrameRoleUserEdit.pas' {FrameRoleUserEdit: TFrame} ,
  uFrameDataRoleEdit
    in 'XTYXGL\uFrameDataRoleEdit.pas' {FrameDataRoleEdit: TFrame} ,
  uFrameDataRoleUserEdit
    in 'XTYXGL\uFrameDataRoleUserEdit.pas' {FrameDataRoleUserEdit: TFrame} ,
  uDialogUserEdit in 'XTYXGL\uDialogUserEdit.pas' {fDialogUserEdit: TFrame} ,
  uFrameSetUserRole
    in 'XTYXGL\uFrameSetUserRole.pas' {FrameSetUserRole: TFrame} ,
  uFrameSetUserDataRole
    in 'XTYXGL\uFrameSetUserDataRole.pas' {FrameSetUserDataRole: TFrame} ,
  ...
  uFrameTaskManager
    in 'DataAnalyse\uFrameTaskManager.pas' {FrameTaskManager: TFrame} ,
  UToolNocturnal in 'DataAnalyse\UToolNocturnal.pas' {ToolNocturnal: TFrame} ,
  uFrameCrashManager
    in 'DataAnalyse\uFrameCrashManager.pas' {FrameCrashManager: TFrame} ,
  uFrameBetweenManager
    in 'DataAnalyse\uFrameBetweenManager.pas' {FrameBetweenManager: TFrame} ,
  uFrameFollowManager
    in 'DataAnalyse\uFrameFollowManager.pas' {FrameFollowManager: TFrame} ,
  UFrameAddCrash in 'DataAnalyse\UFrameAddCrash.pas' {FrameAddCrash: TFrame} ,
  UFrameAddBetween
    in 'DataAnalyse\UFrameAddBetween.pas' {FrameAddBetween: TFrame} ,
  UFrameAddFollow
    in 'DataAnalyse\UFrameAddFollow.pas' {FrameAddFollow: TFrame} ,
  ...
  uFrameForceFeedback
    in 'BKGJGL\uFrameForceFeedback.pas' {FrameForceFeedback: TFrame} ,
  uFrameFeedbackBase
    in 'BKGJGL\uFrameFeedbackBase.pas' {FrameFeedbackBase: TFrame} ,
  ...
  uFrameYXQZFeedback
    in 'BKGJGL\uFrameYXQZFeedback.pas' {FrameYXQZFeedback: TFrame} ,
  uFrameJianYiFeedback
    in 'BKGJGL\uFrameJianYiFeedback.pas' {FrameJianYiFeedback: TFrame} ,
  ...
  uFrameDCWFFeedback
    in 'BKGJGL\uFrameDCWFFeedback.pas' {FrameDCWFFeedback: TFrame} ,
  uFrameFeedbackResult
    in 'BKGJGL\uFrameFeedbackResult.pas' {FrameFeedbackResult: TFrame} ,
  ...
  uFrameFineFeedback
    in 'BKGJGL\uFrameFineFeedback.pas' {FrameFineFeedback: TFrame} ,
  uFrameWait in 'Main\uFrameWait.pas' {FrameWait: TFrame} ,
  uFrameVideo in 'Main\uFrameVideo.pas' {FrameVideo: TFrame} ,
  FHNSBSATXLib_TLB in 'Common\FHNSBSATXLib_TLB.pas',
  FHNSBSDLGATXLib_TLB in 'Common\FHNSBSDLGATXLib_TLB.pas',
  FHZWNDOCXLib_TLB in 'Common\FHZWNDOCXLib_TLB.pas',
  ...
  uFrameQDZViewBase
    in 'ZHGL\View\uFrameQDZViewBase.pas' {FrameQDZViewBase: TFrame} ,
  uFrameQDZView in 'ZHGL\View\uFrameQDZView.pas' {FrameQDZView: TFrame} ,
  uFrameQDZViewDev
    in 'ZHGL\View\uFrameQDZViewDev.pas' {FrameQDZViewDev: TFrame} ,
  uFramZBGL in 'ZHGL\uFramZBGL.pas' {FrameZBGL: TFrame} ,
  uFrameCreateZBList
    in 'ZHGL\uFrameCreateZBList.pas' {FrameCreateZBList: TFrame} ,
  ...
  uFrameAddNocturnal
    in 'DataAnalyse\uFrameAddNocturnal.pas' {FrameAddNocturnal: TFrame} ,
  ...
  UFrameAddFirstEnter
    in 'DataAnalyse\UFrameAddFirstEnter.pas' {FrameAddFirstEnter: TFrame} ,
  uFrameFirstEnterManager
    in 'DataAnalyse\uFrameFirstEnterManager.pas' {FrameFirstEnterManager: TFrame} ,
  ...
  uZHPTFunctionRole
    in 'ZHPTGL\uZHPTFunctionRole.pas' {ZHPTFunctionRole: TFrame} ,
  uAddZHPTFunction
    in 'ZHPTGL\uAddZHPTFunction.pas' {FrameAddZHPTFunction: TFrame} ,
  uFrameZHPTFunctionRoleEdit
    in 'ZHPTGL\uFrameZHPTFunctionRoleEdit.pas' {FrameZHPTFunctionRoleEdit: TFrame} ,
  uFrameZHPTFunctionRoleUser
    in 'ZHPTGL\uFrameZHPTFunctionRoleUser.pas' {FrameZHPTFunctionRoleUser: TFrame} ,
  uFrameZHPTDeviceRole
    in 'ZHPTGL\uFrameZHPTDeviceRole.pas' {FrameZHPTDeviceRole: TFrame} ,
  uFrameAddZHPTDevice
    in 'ZHPTGL\uFrameAddZHPTDevice.pas' {FrameAddZHPTDevice: TFrame} ,
  uFrameZHPTDeviceRoleEdit
    in 'ZHPTGL\uFrameZHPTDeviceRoleEdit.pas' {FrameZHPTDeviceRoleEdit: TFrame} ,
  uFrameZHPTDeviceRoleUser
    in 'ZHPTGL\uFrameZHPTDeviceRoleUser.pas' {FrameZHPTDeviceRoleUser: TFrame} ,
  uPicView in 'BaseFrame\uPicView.pas' {PicView: TFrame} ,
  uFrameZDTotal in 'SJTJFX\uFrameZDTotal.pas' {FrameZDTotal: TFrame} ,
  uCarFaceCompare
    in 'ZHXXCX\uCarFaceCompare.pas' {FrameCarFaceCompare: TFrame} ,
  ...
  uFrameSecurityLogTotal
    in 'XTYXGL\uFrameSecurityLogTotal.pas' {FrameSecurityLogTotal: TFrame} ,
  uFrameSecurityLogView
    in 'XTYXGL\uFrameSecurityLogView.pas' {FrameSecurityLogView: TFrame} ,
  uDialogPolicySetting
    in 'XTYXGL\uDialogPolicySetting.pas' {fDialogPolicySetting: TFrame} ,
  uSelfInfo in 'Main\uSelfInfo.pas' {frmSelfInfo};
...
{$ELSE}
    ...
    b := CheckLogin and CheckPasswordSecurity;
