...
var
  ...
  Param, MenuID, FunctionID, s: String;
  i, j, k: Integer;
begin
  inherited;
  ...
  s := TRequestItf.DbQuery('GetZHPTFunctionRole', Param);
  ...
  begin
    ...
    s := TRequestItf.DbQuery('AddZHPTFunctionRole', Param);
    if TCommon.GetJsonNode('code', s) = '0' then
    begin
