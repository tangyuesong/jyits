...
type
  TFrameFineFeedback = class(TToolGridFrame)
...
var
  FrameFineFeedback: TFrameFineFeedback;
...
procedure TFrameFineFeedback.acteditExecute(Sender: TObject);
begin
  inherited;
  btnFeedbackClick(nil);
end;

procedure TFrameFineFeedback.AfterConstruction;
begin
  inherited;
...
procedure TFrameFineFeedback.btnFeedbackClick(Sender: TObject);
var
  alarm: TAlarmResult;
begin
  inherited;
...
procedure TFrameFineFeedback.Timer1Timer(Sender: TObject);
var
  s: String;
begin
  inherited;
  ...
  ShowFrameWait;
  s := TRequestItf.DbQuery('GetFineAlarmResult', 'YHBH=' + gUser.yhbh);
