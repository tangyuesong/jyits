...
uses
  ...
  uJsonUtils, uCommon, uFrameZBGL_RY, uFrameCreateZBList, uDictionary, uEntity;
...
begin
  ...
  cbbDWMC.Properties.Items.Add('È«²¿');
  ...
  GridColumns := 'DWMC,ZBSJ,ZBLD,LDDH,ZBMJ,MJDH,ZBXJ,XJDH';
  cxButton1Click(nil);
end;
