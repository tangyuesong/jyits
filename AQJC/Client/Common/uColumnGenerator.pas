...
begin
  ...
  (col.Properties as TcxLookupComboBoxProperties).KeyFieldNames :=
    KeyFieldNames;
  (col.Properties as TcxLookupComboBoxProperties).ListSource := ds;
  (col.Properties as TcxLookupComboBoxProperties).ListFieldNames :=
    ListFieldNames;

end;

class procedure TColumnGenerator.LookupRow(col: TcxGridDBCardViewRow;
  ds: TDataSource);
var
...
class procedure TColumnGenerator.LookupColumn(col: TcxGridColumn;
  ds: TDataSource);
var
  KeyFieldNames, ListFieldNames: string;
begin
