    ...
    begin
      ...
      begin
        s := '{"id":"' + TCommon.GetJsonNode('id', Rows.Items[i].value) + '",' +
          ...
          + '","picurl":"http://10.43.255.8:18088' +
          TCommon.GetJsonNode('picurl', Rows.Items[i].value) +
          '&appname=PIC&isstream=1",' + '"hphm":"' +
    ...
    begin
      ...
      begin
        s := '{"gcsj":"' + FormatDateTime('yyyy/mm/dd hh:nn:ss',
          ...
          '","picurl":"http://10.43.255.8:18088' + TCommon.GetJsonNode
          ('imagepath', Rows.Items[i].value) + '&appname=PIC&isstream=1",' +
          '"hphm":"' + TCommon.GetJsonNode('plateno', Rows.Items[i].value) +
          '","latitude":"' + TCommon.GetJsonNode('latitude',
          Rows.Items[i].value) + '","longitude":"' +
          TCommon.GetJsonNode('longitude', Rows.Items[i].value) + '",';
      ...
      begin
        ...
        begin
          ...
          if gK08Csys.ContainsKey(csys) then
            ...
            Info := Info + '"csys":"' + csys + '",';
          Info := Info + '"picurl":"http://10.43.255.8:18088' +
